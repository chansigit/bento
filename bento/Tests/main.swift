...
expectEq(wifiQualityLabel(level: 4), "极好", "level 4 label")
expectEq(wifiQualityLabel(level: 3), "良好", "level 3 label")
expectEq(wifiQualityLabel(level: 2), "一般", "level 2 label")
expectEq(wifiQualityLabel(level: 1), "弱", "level 1 label")
